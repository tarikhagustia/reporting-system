            ...
            <form role="form" method="post" action="{{route('product.add.post')}}">
              ...
              <div class="box-body">
                ...
                <div class="form-group @if($errors->has('purchase_price')) has-error @endif">
                  ...
                  <input class="form-control" id="purchase_price" name="purchase_price" placeholder="Harga Beli" type="text">
                  <p class="help-block">
                ...
                <div class="form-group @if($errors->has('selling_price')) has-error @endif">
                  ...
                  <input class="form-control" id="selling_price" name="selling_price" placeholder="Harga jual" type="text">
                  <p class="help-block">
                ...
                <div class="form-group @if($errors->has('stock')) has-error @endif">
                  ...
                  <input class="form-control" id="stock" name="stock" placeholder="Stok awal" type="text">
                  <p class="help-block">
                    {{$errors->first('stock')}}
                  </p>
                </div>
